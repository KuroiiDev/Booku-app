<x-guest-layout>
    ...
    <div class="mb-8 text-center">
        <h2 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-white heading-font">Selamat Datang Kembali
        </h2>
        ...
        <div class="flex items-center justify-between mt-5">
            <label for="remember_me" class="inline-flex items-center cursor-pointer">
                <input id="remember_me" type="checkbox"
                    class="rounded-md dark:bg-slate-900 border-gray-300 dark:border-slate-700 text-amber-500 shadow-sm focus:ring-amber-500 dark:focus:ring-offset-slate-900"
                    name="remember">
    ...
    <div class="mt-8 text-center border-t border-slate-100 dark:border-slate-700/50 pt-6">
        <p class="text-sm text-slate-500 dark:text-slate-400 font-medium">
            ...
            <a href="{{ route('register') }}"
                class="font-bold text-amber-600 hover:text-amber-500 dark:text-amber-500 dark:hover:text-amber-400 transition-colors ml-1">Daftar
                Anggota</a>
        </p>
    </div>
</x-guest-layout>
